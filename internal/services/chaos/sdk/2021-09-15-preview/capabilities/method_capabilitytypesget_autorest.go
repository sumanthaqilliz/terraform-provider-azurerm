...
// CapabilityTypesGet ...
func (c CapabilitiesClient) CapabilityTypesGet(ctx context.Context, id CapabilityTypeId) (result CapabilityTypesGetResponse, err error) {
...
func (c CapabilitiesClient) responderForCapabilityTypesGet(resp *http.Response) (result CapabilityTypesGetResponse, err error) {
