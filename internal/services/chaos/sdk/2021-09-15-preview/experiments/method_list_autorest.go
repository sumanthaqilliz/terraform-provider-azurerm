...
// List ...
func (c ExperimentsClient) List(ctx context.Context, id ResourceGroupId, options ListOptions) (resp ListResponse, err error) {
...
func (c ExperimentsClient) ListComplete(ctx context.Context, id ResourceGroupId, options ListOptions) (ListCompleteResult, error) {
	return c.ListCompleteMatchingPredicate(ctx, id, options, ExperimentPredicate{})
}

// ListCompleteMatchingPredicate retrieves all of the results and then applied the predicate
func (c ExperimentsClient) ListCompleteMatchingPredicate(ctx context.Context, id ResourceGroupId, options ListOptions, predicate ExperimentPredicate) (resp ListCompleteResult, err error) {
...
func (c ExperimentsClient) preparerForList(ctx context.Context, id ResourceGroupId, options ListOptions) (*http.Request, error) {
...
func (c ExperimentsClient) responderForList(resp *http.Response) (result ListResponse, err error) {
	type page struct {
