...
type ListExecutionDetailsResponse struct {
	HttpResponse *http.Response
	Model        *[]ExperimentExecutionDetails

	nextLink     *string
	nextPageFunc func(ctx context.Context, nextLink string) (ListExecutionDetailsResponse, error)
}
...
func (r ListExecutionDetailsResponse) HasMore() bool {
	return r.nextLink != nil
}

func (r ListExecutionDetailsResponse) LoadMore(ctx context.Context) (resp ListExecutionDetailsResponse, err error) {
	if !r.HasMore() {
...
func (c ExperimentsClient) ListExecutionDetails(ctx context.Context, id ExperimentId) (resp ListExecutionDetailsResponse, err error) {
...
func (c ExperimentsClient) ListExecutionDetailsComplete(ctx context.Context, id ExperimentId) (ListExecutionDetailsCompleteResult, error) {
	return c.ListExecutionDetailsCompleteMatchingPredicate(ctx, id, ExperimentExecutionDetailsPredicate{})
}

// ListExecutionDetailsCompleteMatchingPredicate retrieves all of the results and then applied the predicate
func (c ExperimentsClient) ListExecutionDetailsCompleteMatchingPredicate(ctx context.Context, id ExperimentId, predicate ExperimentExecutionDetailsPredicate) (resp ListExecutionDetailsCompleteResult, err error) {
...
func (c ExperimentsClient) responderForListExecutionDetails(resp *http.Response) (result ListExecutionDetailsResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result ListExecutionDetailsResponse, err error) {
