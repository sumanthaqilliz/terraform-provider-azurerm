...
// Start ...
func (c ExperimentsClient) Start(ctx context.Context, id ExperimentId) (result StartResponse, err error) {
...
func (c ExperimentsClient) responderForStart(resp *http.Response) (result StartResponse, err error) {
