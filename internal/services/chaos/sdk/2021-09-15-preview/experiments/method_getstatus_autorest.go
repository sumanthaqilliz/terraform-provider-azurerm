...
// GetStatus ...
func (c ExperimentsClient) GetStatus(ctx context.Context, id StatuseId) (result GetStatusResponse, err error) {
...
func (c ExperimentsClient) responderForGetStatus(resp *http.Response) (result GetStatusResponse, err error) {
