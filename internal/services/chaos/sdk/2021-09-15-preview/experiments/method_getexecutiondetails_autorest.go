...
// GetExecutionDetails ...
func (c ExperimentsClient) GetExecutionDetails(ctx context.Context, id ExecutionDetailId) (result GetExecutionDetailsResponse, err error) {
...
func (c ExperimentsClient) responderForGetExecutionDetails(resp *http.Response) (result GetExecutionDetailsResponse, err error) {
